        ...
        <article className="flex justify-between items-center py-8 gap-4 flex-wrap lg:flex-nowrap flex-col-reverse lg:flex-row">
          ...
          <div className="lg:flex-1 flex justify-center flex-col lg:items-center relative overflow-x-hidden w-full">
            ...
            <p className="font-monset text-xl lg:w-[50vw] py-4 px-2">
              ...
              medio de la fibra óptica de última generación, enfocados en
              mantener a nuestros usuarios conectados al mundo digital donde se
              les conceda una adecuada trasmisión de datos a alta velocidad,
              brindando un servicio de calidad de la mano de una atención
              técnica oportuna que nos permita hacer clientes felices.
            </p>
          </div>
        </article>
        <article className="flex justify-between items-center py-8 gap-4 flex-wrap lg:flex-nowrap">
          <div className="lg:flex-1 flex justify-center flex-col items-center w-full">
            ...
            <SpinnerVision />
            <p className="font-monset text-xl lg:w-[50vw] py-4 px-2">
              Para el año 2025 Costanet será una empresa reconocida
              nacionalmente, con una extensa variedad de planes domiciliarios y
              empresariales disponibles para todo público gracias a la oportuna
              adecuación de nuestros paquetes de internet a la economía de cada
              sector, distribuyendo nuestros servicios en las grandes ciudades
              de Colombia, siendo una empresa solida financieramente y
              proporcionando empleo local en cada una de nuestras sedes.
            </p>
          </div>
