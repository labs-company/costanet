                ...
                <Dialog.Panel className='w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                  ...
                  <div className='py-4 grid grid-cols-2'>
                    <div className='py-6'>
                      ...
                      <ListMedia
                        mediaOne={{
                          name: 'Costanet Santa Ana',
                          link: 'https://www.facebook.com/costanetiptv.santaana',
                        }}
                        mediaTwo={{
                          name: 'Costanet Cicuco',
                          link: 'https://www.facebook.com/profile.php?id=100085553010151',
                        }}
                        mediaThree={{
                          name: 'Costanet Talaigua',
                          link: 'https://www.facebook.com/COSTANETTALAIGUA',
                        }}
                      />
                    </div>
                    <div className='py-6'>
